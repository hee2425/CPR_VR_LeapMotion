...
public class CardboardEditor : Editor {
  ...
  GUIContent editorSettingsLabel = new GUIContent("Unity Editor Emulation Settings", "Controls for the in-editor emulation of a Cardboard viewer."); GUIContent UseUnityRemoteInputLabel = new GUIContent("Use unity remote as the input.", "When you can use Unity Remote Gyro");
  ...
  public override void OnInspectorGUI() {
    ...
    EditorGUILayout.Separator();
        ...
        cardboard.autoUntiltHead = EditorGUILayout.Toggle(autoUntiltHeadLabel, cardboard.autoUntiltHead);
        cardboard.UseUnityRemoteInput = EditorGUILayout.Toggle(UseUnityRemoteInputLabel, cardboard.UseUnityRemoteInput);
